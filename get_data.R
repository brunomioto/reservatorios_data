...
#testecsv <- read.csv("https://raw.githubusercontent.com/brunomioto/pesquisas_eleitorais/master/database/base.csv")

busca_res <- function(codigo_reservatorio){
  
  reservatoriosBR::reservatorio_sin(codigo_reservatorio, data_inicial = "2021-01-01", data_final = "2021-01-31")
